...
<spring:url value="/moreDataEventScheduled" var="moreData" />
<spring:url value="/dataModalEvent" var="dataModal" />
<spring:url value="/imagesEventData" var="imagesData" />
<spring:url value="/dataEventScheduled" var="dataEvent" />
